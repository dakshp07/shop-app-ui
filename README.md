...
A Shopping App UI Which is made using Dart,Flutter.
...
2) Run The Following Commands :
```git
$ git clone https://github.com/dakshp07/shop-app-ui.git
```
...
![Second](images/Screenshot_1602947323.png)

![Third](images/Screenshot_1602947336.png)
